const channel_settings_default = [
  { channel_type: 'youtube', channel_vid: 'KGBv8oT5lwk', channel_title: 'title1'},
  { channel_type: 'youtube', channel_vid: '-eUtoororgQ', channel_title: 'title2'},
  { channel_type: 'youtube', channel_vid: '-eUtoororgQ', channel_title: 'title3'},
  { channel_type: 'youtube', channel_vid: '-eUtoororgQ', channel_title: 'title4'},
  { channel_type: 'youtube', channel_vid: '-eUtoororgQ', channel_title: 'title5'},
  { channel_type: 'youtube', channel_vid: '-eUtoororgQ', channel_title: 'title6'},
  { channel_type: 'youtube', channel_vid: '-eUtoororgQ', channel_title: 'title7'}
]
