    ...
    <div className={active_style.tabs}>
      <ul>
        <li className={active_style.isActive}>
          <a>Pictures {chineseTestShort()}</a>
        </li>
        <li>
          <a>Music {chineseTestShort()}</a>
        </li>
        <li>
          <a>Videos {chineseTestShort()}</a>
        </li>
        <li>
          <a>Documents {chineseTestShort()}</a>
        </li>
      </ul>
    </div>
    <br />
